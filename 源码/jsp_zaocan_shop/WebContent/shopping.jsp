...
<div id="position" class="wrap">
	您现在的位置：<a href="index.html">安心早餐店</a> &gt; 购物车
</div>
<div class="wrap">
	<div id="shopping">
				...
				<c:forEach var="rs" items="${requestScope.shoplist}">
					...
					<tr id="product_id_1">
						...
						<td class="price" id="price_id_1">
							<span id="priceText" name="priceText" >${rs.es_ep_price}</span><!-- 餐饮单价 --><input type="hidden" name="sPPrice" value="${rs.es_ep_price}" />
						...
						<td class="number">
							<dl>
								...
								<!-- 餐饮id --><input type="hidden" name="spID" value="${rs.es_ep_id}" />
	...
	<script type="text/javascript">
		document.write("Cookie中记录的购物车餐饮ID："+ getCookie("product") + "，可以在动态页面中进行读取");
	</script>
</div>
<div id="footer">
	Copyright &copy; 2019 安心早餐店 All Rights Reserved. 沪ICP备案000001号
</div>
</body>
</html>
<script>
