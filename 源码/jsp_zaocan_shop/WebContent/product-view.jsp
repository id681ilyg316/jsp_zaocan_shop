...
<div id="position" class="wrap">
	您现在的位置：<a href="indexSelect">安心早餐店</a> &gt; <a href="selectProductList">餐饮分类</a> &gt; ${title }
</div>
<div id="main" class="wrap">
	<div class="lefter">
		<div class="box">
			<h2>餐饮分类</h2>
			<dl>
				<dt><a href="selectProductList">全部餐饮</a></dt>
				<c:forEach var="f" items="${flist}">
	...
	<div id="product" class="main">
		...
		<div id="mag"><img id="magnifierImg" /></div>
			...
			<div class="buy">
				...
				<p>邮递方式：<font color="red">商家配送</font></p>
				<p>热卖程度：☆☆☆☆☆</p>
